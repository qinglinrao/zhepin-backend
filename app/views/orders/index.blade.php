  ...
  <div class="order-form-list">
        ...
        <div class="order-form-item">
          <div class="item-top clearfix">
            ...
            <div class="top-right">
              <span>{{$order->is_profited?'已分润':get_order_status()[$order->status_id]}}-</span>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="one">
                          ...
                          <img src="{{$order_product->product&&$order_product->product->thumb?AppHelper::imgSrc($order_product->product->thumb->url):''}}" width="60" height="60">
                          </a>
                        </td>
                        <td class="two">
                          <div class="td-wrap">
