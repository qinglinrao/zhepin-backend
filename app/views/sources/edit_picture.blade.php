...
<div class="source-library">
    ...
    <div class="add-source">
        ...
        {{Form::open(array('url'=>URL::route('sources.update_source',['id'=>$source->id]),'class'=>'data-form'))}}
            ...
            @endif
            {{Form::hidden('source[source_type]',1)}}
            ...
            <div class="form-group">
                ...
                <div class="form-images">
                    @foreach(_analyseImgs('',$source->content) as $image)
                    <div class="preview-image">
                        {{$image}}
                        <button class="delete">x</button>
                    </div>
                    @endforeach
                    {{Form::hidden('source[content]',$source->content,['id'=>'source_content'])}}
                </div>

                {{--{{Form::textarea('source[content]',$source->content,['class'=>'form-textarea editor'])}}--}}
            </div>
            <div class="form-group">
