 ...
 */
define(['application', 'backbone.marionette'], function() {
    var Page = {
        View: {}
    };

    Page.View.list = Marionette.ItemView.extend({
        template: "#image-view-template"
    });
    console.log(Page);

    Page.View.preview = Marionette.ItemView();
